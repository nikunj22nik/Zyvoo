...
class RadioTextAdapter(
    private val items: List<ItemRadio>,var lisner : OnClickListener,
...
) : RecyclerView.Adapter<RadioTextAdapter.ViewHolder>()
{
    ...
    inner class ViewHolder(view: View) : RecyclerView.ViewHolder(view) {
        ...
        fun bind(item: ItemRadio, position: Int) {
            ...
            itemView.setOnClickListener {
                // Unselect the previously selected radio button
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val view = LayoutInflater.from(parent.context).inflate(R.layout.layout_text_with_radio, parent, false)
