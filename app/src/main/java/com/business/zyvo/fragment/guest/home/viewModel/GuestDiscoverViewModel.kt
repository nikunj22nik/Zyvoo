...
@HiltViewModel
class GuestDiscoverViewModel @Inject constructor(
    ...
    suspend fun removeItemFromWishlist(
        ...
        property_id: String
            ...
            Flow<NetworkResult<Pair<String, String>>> {
        return repository.removeItemFromWishlist(
            userId,
            property_id
        ).onEach {
            when (it) {
    ...
    suspend fun saveItemInWishlist(
        ...
        wishlist_id: String
            ...
            Flow<NetworkResult<Pair<String, String>>> {
        return repository.saveItemInWishlist(
            userId,
            property_id,
            wishlist_id
        ).onEach {
    ...
    suspend fun getFilterHomeDataApi(
        userId: String?,
        latitude: String?,
        longitude: String?,
        place_type: String?,
        ...
        return repository.getFilteredHomeData(
            userId,
            latitude,
            longitude,
            place_type,
    ...
    suspend fun getHomeDataSearchFilter(
        ...
        property_price: String
            ...
            Flow<NetworkResult<JsonArray>> {
        return repository.getHomeDataSearchFilter(
            user_id, latitude, longitude, date,
            hour, start_time, end_time, activity, property_price
        ).onEach {
            when (it) {
                is NetworkResult.Loading -> {
                    isLoading.value = true
