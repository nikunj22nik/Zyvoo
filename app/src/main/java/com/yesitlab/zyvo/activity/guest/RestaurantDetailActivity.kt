...
private  var _binding : ActivityRestaurantDetailBinding? = null
...
=======
        _binding = ActivityRestaurantDetailBinding.inflate(LayoutInflater.from(this))
>>>>>>> Stashed changes
...
=======
        ...
        Log.d("TESTING_RestaurantDetailActivity","I AM HERE IN DEVELOPMENT")
        binding.rlTextReviewClick?.setOnClickListener {
            Log.d("TESTING_RestaurantDetailActivity","click")
            Toast.makeText(
